...
namespace engine::graphics {
    ...
    void GraphicsController::draw_bloom_result() {
        bool horizontal      = true;
        bool first_iteration = true;

        auto blur_shader = engine::core::Controller::get<engine::resources::ResourcesController>()
                ->shader("blur");
        ...
        auto final_shader = engine::core::Controller::get<engine::resources::ResourcesController>()
                ->shader("bloom_final");
